...
export const LineChart2 = (/* props: LineChartProps */): JSXElement => {
            ...
            events: [
              {
                ...
                onRenderCard: () => (
                  <div /* className={calloutItemStyle} */>event 1 message</div>
                ),
              },
              {
                event: "event 2",
                date: new Date("2020-03-04T00:00:00.000Z"),
                onRenderCard: () => (
                  <div /* className={calloutItemStyle} */>event 2 message</div>
                ),
              },
              {
                event: "event 3",
                date: new Date("2020-03-04T00:00:00.000Z"),
                onRenderCard: () => (
                  <div /* className={calloutItemStyle} */>event 3 message</div>
                ),
              },
              {
                event: "event 4",
                ...
                onRenderCard: () => (
                  <div /* className={calloutItemStyle} */>event 4 message</div>
                ),
              },
              {
                event: "event 5",
                ...
                onRenderCard: () => (
                  <div /* className={calloutItemStyle} */>event 5 message</div>
                ),
              },
            ],
